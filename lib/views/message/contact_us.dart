    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: _messageCon.chatSearchTextController.text==''
          ...
          :SearchResultPage(messages: contactUsMessageslist)
        )
      ),
    );
  }
    ...
    return Column(
      ...
      children: [
            ...
            Expanded(
              child: Padding(
                ...
                child: StreamBuilder<List<Message>>(
                  stream: FirestoreServices.getInquiryChatMessages(_messageCon.userId.toString(),true),
                  builder:(BuildContext context, AsyncSnapshot messageSnapshot) {
                    if (messageSnapshot.hasError || !messageSnapshot.hasData) {
                      ...
                      contactUsMessageslist = messageSnapshot.data;
                                ...
                                children: [
                                  ...
                                  :Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Visibility(
                                          visible: currentSelectedIndex == index 
                                          ...
                                          child: Padding(
                                            ...
                                            child: MessageMenuWidget(
                                              ...
                                              index: index, 
                                              chatRoomId: _messageCon.userId.toString(), 
                                              globalkey: null, 
                                                    ...
                                                    children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        ?GestureDetector(
                                                          onTap: (){
                                                            setState(() {
                                                              _messageCon.chatTextCon.text = _messageCon.chatTextCon.text+' '+messageSnapshot.data[index].senderName;
                                                            });
                                                          },
                                                          child: Text(
                                                        ...
                                                        :GestureDetector(
                                                          onTap: (){
                                                            ...
                                                            setState(() {
                                                              _messageCon.chatTextCon.text = _messageCon.chatTextCon.text+' '+senderName;
                                                            });
                                                          },
                                                          child: Text(
                                                          ...
                                                          ? GestureDetector(
                                                            ...
                                                            child: MessageBubbleWidget(
                                                              ...
                                                              child: StreamBuilder<Message>(
                                                                stream: FirestoreServices.replyMsgInquiryDetail(_messageCon.userId.toString(),messageSnapshot.data[index].reply),
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                SizedBox(
                                                                                  ...
                                                                                  width: 28,
                                                                                  child: CircleAvatar(
                                                                                    backgroundColor:_messageCon.userId.toString()!= messageSnapshot.data[index].senderId?primaryColor:white,
                                                                                    child: ClipRRect(
                                                                                      borderRadius: BorderRadius.circular(80),
        ...
        Obx(()=>
          ...
          ?ReplyMessageWidget(userId: _messageCon.userId,fbCollectionName: "contact-us")
          :const SizedBox()
        ),
        //message textfield and send buttons
        const MessageBar(forPage:'teacher')
      ],
    );
  }
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  //lastMessage date setup
                                  //if message day is same as last msg
                                  :index == messageSnapshot.data.length-1 && DateFormat('EEEE','ja').format(messageSnapshot.data[index].datetime).toString() == curMessageDay
                                  ?SystemMessageBadgeWidget(text: formattedlastMessageDate+' '+'('+lastMessageDay+')',msgType: 'date')
                                  :const SizedBox(),
                                  //if message type is SYSTEM MESSAGE == TRUE
                                  messageSnapshot.data[index].systemMessage == "true" && messageSnapshot.data[index].text == "メッセージの送信を取り消しました"
                                                                                    ...
                                                                                    children: [
                                                                                      Theme(
                                                                                        ...
                                                                                        ?SelectableText(
                                                                                          messageDetailSnapShot.data.senderName,
                                                                                          maxLines: 1,
                                                                                          style: _messageCon.userId.toString() != messageSnapshot.data[index].senderId?chatTextBlackHeaderStyle:chatTextWhiteHeaderStyle,
                                                                                        )
                                                                                        :SelectableText(
                                                                                          replyUserInfo.data.nickname,
                                                                                          maxLines: 1,
