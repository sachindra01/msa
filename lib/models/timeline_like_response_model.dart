...
//
//     final timeLineLikeResponse = timeLineLikeResponseFromJson(jsonString);

import 'dart:convert';

TimeLineLikeResponse timeLineLikeResponseFromJson(String str) => TimeLineLikeResponse.fromJson(json.decode(str));

String timeLineLikeResponseToJson(TimeLineLikeResponse data) => json.encode(data.toJson());

class TimeLineLikeResponse {
    TimeLineLikeResponse({
        this.success,
        this.message,
        this.data,
        this.code,
    ...
    factory TimeLineLikeResponse.fromJson(Map<String, dynamic> json) => TimeLineLikeResponse(
